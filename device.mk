...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/rootdir/etc/init.hammerhead.diag.rc.userdebug:root/init.hammerhead.diag.rc
PRODUCT_PACKAGES += \
    QXDMLogger
else
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/rootdir/etc/init.hammerhead.diag.rc.user:root/init.hammerhead.diag.rc
endif
