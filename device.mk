...
PRODUCT_COPY_FILES += \
    ...
    device/lge/hammerhead/rootidr/ueventd.hammerhead.rc:root/ueventd.hammerhead.rc

# Input device files for hammerhead
PRODUCT_COPY_FILES += \
    device/lge/hammerhead/keylayouts/gpio-keys.kl:system/usr/keylayout/gpio-keys.kl \
    device/lge/hammerhead/keylayouts/gpio-keys.kcm:system/usr/keychars/gpio-keys.kcm \
    device/lge/hammerhead/keylayouts/qpnp_pon.kl:system/usr/keylayout/qpnp_pon.kl \
    device/lge/hammerhead/keylayouts/qpnp_pon.kcm:system/usr/keychars/qpnp_pon.kcm \
    device/lge/hammerhead/keylayouts/Button_Jack.kl:system/usr/keylayout/msm8974-taiko-mtp-snd-card_Button_Jack.kl \
    device/lge/hammerhead/keylayouts/Button_Jack.kcm:system/usr/keychars/msm8974-taiko-mtp-snd-card_Button_Jack.kcm \
    device/lge/hammerhead/keylayouts/hs_detect.kl:system/usr/keylayout/hs_detect.kl \
    device/lge/hammerhead/keylayouts/hs_detect.kcm:system/usr/keychars/hs_detect.kcm

# Prebuilt input device calibration files
PRODUCT_COPY_FILES += \
    device/lge/hammerhead/keylayouts/touch_dev.idc:system/usr/idc/touch_dev.idc
...
PRODUCT_COPY_FILES += \
    ...
    device/lge/hammerhead/media/media_profiles_V1_0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml

PRODUCT_COPY_FILES += \
    device/lge/hammerhead/wifi/bcmdhd.cal:system/etc/wifi/bcmdhd.cal
...
PRODUCT_COPY_FILES += \
    device/lge/hammerhead/thermal/thermal-engine-8974.conf:system/etc/thermal-engine-8974.conf
