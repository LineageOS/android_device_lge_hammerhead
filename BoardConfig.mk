...
# Dex-preoptimization; speeds up first boot sequence
ifeq ($(HOST_OS),linux)
...
# Recovery
TARGET_RECOVERY_FSTAB = $(LOCAL_PATH)/rootdir/etc/fstab.hammerhead
TARGET_RELEASETOOLS_EXTENSIONS := $(LOCAL_PATH)/recovery
